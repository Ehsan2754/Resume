...
\cventry{2021}
    ...
    {Innopolis University, Tatarstan, Russia}{}{}
    {\href{https://github.com/Ahuratus/Trajectory-Detection-Web-services/tree/main/web}{\textcolor{blue}{Github Repo}} A lightweight web-service providing AI models API }
...
\cventry{2019}
    ...
    {Personal Project}{}{}
    {An IOT device developed in order to control home devices by voice detection.}
