...
\subsection{\textbf{\textcolor{red}{Patents}}}
	\cvline{2022}
    {Visual positioning system for multi-rotor UAVs for high-precision autonomous landing;\textbf{Sevostyanov Ilya Evgenievich (RU),Devitt Dmitry Vladimirovich (RU),Shashkina Ksenia Mikhailovna (RU),Shaghaei Ehsan (IR) ;}  \href{https://new.fips.ru/registers-doc-view/fips_servlet?DB=EVM&DocNumber=2022610258}{\textcolor{blue}{RUSSIAN FEDERAL SERVICE
ON INTELLECTUAL PROPERTY 2022610258} }}
	% \cvline{2017}{GLPS Positioning System;\textbf{Shaghaei,Ehsan;}\textit{14th CRRS National Mathematics Conference (CRRS 2017):} My First Experience as an scholar and a school student. Here developed a naive yet interesting mathematical model for increasing accuracy of GPS. My method purposed using accelerator and shaft-encoder data to append a local positioning method to L1 distance GPS in order to solve challenge of high latency disctance GPS. Apparently, I didn't know about L2  and higher frequency methods by the time :-D }
